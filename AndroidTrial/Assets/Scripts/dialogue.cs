...
public class dialogue : MonoBehaviour
{
    ...
    public void AskQuestion()
    {
        ...
        if (answer1)
        {
            GameObject.Find("Subtitles").GetComponent<Text>().text = Sub1[QuestionList1];
            ans = Sub1[QuestionList1];
            StartCoroutine(DownloadTheAudio(ans));



            GameObject.Find("Text").GetComponent<Text>().text = Reply1[QuestionList2];
            GameObject.Find("Text2").GetComponent<Text>().text = Reply2[QuestionList2];
        }
        if (answer2)
        {
            ...
            GameObject.Find("Subtitles").GetComponent<Text>().text = Sub2[QuestionList2];
